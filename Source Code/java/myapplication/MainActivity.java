...
public class MainActivity extends AppCompatActivity {
        ...
        findPoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (tempPointx > cluster.topRCornerX.get(0)
                                || tempPointy > cluster.topRCornerY.get(0)
                                || tempPointx < cluster.botLCornerX.get(0)
                                || tempPointy < cluster.botLCornerY.get(0)) {
                                // outputNum.setText("Requesting new MBR from Server. Please Wait 5
                                // Seconds Before Finding Closest");
                            ...
                            if (rect == true) {
                                ...
                                //                  outputNum.setText(String.format("(%s,%s)",
                                //                  outVal[0], outVal[1]));
                            }
                ...
                if (rect == true) {
                    ...
                    outputNum.setText(
                        "Requesting new MBR from Server. Please Wait 5 Seconds Before Finding Closest");
                    // loc --;
                }
    ...
    */
    ...
    public returnClass parseFnl(String fname) {
        ...
        try {
            DataInputStream textFileStream =
                new DataInputStream(getAssets().open(String.format(fname)));
            String seperated[];
